/**
 * Static legal / policy guidelines shown in the "Điều khoản & Lưu ý chung"
 * section of every tour. This content is fixed (not returned by the API) and
 * lives here as the single source of truth so the UI just renders it.
 */
...
export const TOUR_TERMS: TermsSection[] = [
  {
    title: "Một số điểm lưu ý",
    items: [
  ...
  {
    title: "Lưu ý tham gia tour du lịch bằng đường hàng không",
    items: [
  ...
  {
    title: "Hành lý ký gửi & Lưu ý khi gửi hành lý",
    items: [
      ...
      "Để đảm bảo an toàn cho hành lý ký gửi, đề nghị Quý khách lưu ý: Không nên để những vật dụng quý như tiền, trang sức, kim loại quý, tài liệu và vật mẫu quan trọng… trong hành lý. Hành lý nên được bao gói chắc chắn và có khóa.",
  ...
  {
    title: "Giấy tờ cần thiết khi đi du lịch",
    items: [
  ...
  {
    title: "Lưu ý khi chuyển/huỷ tour",
    items: [
  ...
  {
    title: "Quy trình đăng ký và thanh toán",
    items: [
